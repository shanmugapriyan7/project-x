...
const Jobcard6 = () => {
  ...
  return (
    <div>
<div class="grid-item" onClick={handleClick6}> <img src={imgy8} ></img>
        <div className='gi'>
        <span >♕ </span>
        <span  >⚡ </span>
        <span  >💾 </span></div>
       <br></br><br></br>
        <span className='ct1'>NETFLIX</span><br></br>
        <span className='ct2'>by Employer 
in Design, Development</span><br></br><br></br>
<button className='cbt1'>Part time</button><button className='cbt2'>Kerala</button><button className='cbt3'>10lpa</button><br></br>
