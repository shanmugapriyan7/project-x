...
<div class="grid-item" onClick={handleClick9}> <img src={imgy11} ></img>
        <div className='gi'>
        <span >♕ </span>
        <span  >⚡ </span>
        <span  >💾 </span></div>
       <br></br><br></br>y
        <span className='ct1'>Software Engineer</span><br></br>
        <span className='ct2'>by Employer 
in Design, Development</span><br></br><br></br>
<button className='cbt1'>Internship</button><button className='cbt2'>Coimbatore</button><button className='cbt3'>10lpa</button><br></br>
