...
const Jobcard10 = () => {
  ...
  return (
    <div>
          <div class="grid-item" onClick={handleClick10}> <img src={imgy12} ></img>
        <div className='gi'>
        <span >♕ </span>
        <span  >⚡ </span>
        <span  >💾 </span></div>
       <br></br><br></br>
        <span className='ct1'>Web Developer</span><br></br>
        <span className='ct2'>by Employer 
in Design, Development</span><br></br><br></br>
<button className='cbt1'>Full time</button><button className='cbt2'>Chennai</button><button className='cbt3'>10lpa</button><br></br>
<span className='deadline'>Deadline date: May 18, 2026</span></div>  
    </div>
  )
}

export default Jobcard10