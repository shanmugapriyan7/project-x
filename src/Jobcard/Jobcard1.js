...
const Jobcard1 = () => {
  ...
  <div class="grid-item" onClick={handleClick1}>
        <img src={img14} ></img>
        <div className='gi'>
        <span >♕ </span>
        <span  >⚡ </span>
        <span  >💾 </span></div>
       <br></br><br></br>
        <span className='ct1'>Junior Graphic Designer (Web)</span><br></br>
        <span className='ct2'>by Employer 
in Design, Development</span><br></br><br></br>
<button className='cbt1'>Full time</button><button className='cbt2'>Coimbatore</button><button className='cbt3'>10lpa</button><br></br>
<span className='deadline'>Deadline date: May 18, 2026</span>
  </div>
    </div>
  )
}
