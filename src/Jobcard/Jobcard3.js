...
<div class="grid-item" onClick={handleClick3}> <img src={imgy3} ></img>
        <div className='gi'>
        <span >♕ </span>
        <span  >⚡ </span>
        <span  >💾 </span></div>
       <br></br><br></br>
        <span className='ct1'>Executive, HR Operations</span><br></br>
        <span className='ct2'>by Employer 
in Design, Development</span><br></br><br></br>
<button className='cbt1'>Full time</button><button className='cbt2'>Bangalore</button><button className='cbt3'>10lpa</button><br></br>
