...
const Jobcard4 = () => {
  ...
  return (
    <div>
          <div class="grid-item" onClick={handleClick4}> <img src={imgy4} ></img>
        <div className='gi'>
        <span >♕ </span>
        <span  >⚡ </span>
        <span  >💾 </span></div>
       <br></br><br></br>
        <span className='ct1'>Senior Product Designer</span><br></br>
        <span className='ct2'>by Employer 
in Design, Development</span><br></br><br></br>
<button className='cbt1'>Part Time</button><button className='cbt2'>Coimbatore</button><button className='cbt3'>10lpa</button><br></br>
