...
import img2 from '../Images/y10.jpg';
...
const JobDescription1 = () => {
  ...
  return (
    <div className={`jdc ${dark?'Djdc':''}`}>
  
<Header/>
<br></br><br></br><br></br>

  <div  style={{height:'695px',width:'1515PX',marginTop:'-50px'}} className={`Apply ${isApply ? 'job' : ''}`}>
...
<button style={{width:'50px',height:'50px',borderRadius:'50px',fontSize:'22px',border:'none',color:'purple',backgroundColor:'white'}} onClick={ApplyJobBack}>&#x2190; </button>
   ...
   <button style={{width:'500px',height:'40px',borderRadius:'10px'}} onClick={ApplyJob2} className='Apply-btn'  >Click here to Confirm</button><br></br><br></br>
      ...
      <br></br>
        <br></br>
      <button style={{border:'none',color:'white',background:'purple',width:'100px',height:'30px'}} onClick={DarkTheme}>{read ? 'Readmode': 'Defaultmode'}</button>
        ...
        Restaurant Team Member
          ...
          <span style={{ color: 'grey', marginLeft: '20px' }}>Coimbatore</span>
